/**
  * @file songs/ZeldaTheme.c
  * @brief Note sequence asset for "Zelda Theme".
  *
  ...
  *
  * Usage
  * - Reference the symbol `ZeldaTheme` to schedule or play this melody.
  *
  * Notes
...
const SongNotes ZeldaTheme = {
  ...
  139,   // Number of Notes
  {
    ...
    {NOTE_AS3, NOTE_TYPE_QUARTER_TRIPLET_DOUBLE, 0},
    {NOTE_GS3, NOTE_TYPE_QUARTER_TRIPLET, 0},
